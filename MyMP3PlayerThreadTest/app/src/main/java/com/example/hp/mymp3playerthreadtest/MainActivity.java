package com.example.hp.mymp3playerthreadtest;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView txtMusic, txtTime;
        ...
        switch (view.getId()) {
            case R.id.btnPlay:
                ...
                try {
                    ...
                    txtMusic.setText("실행중인 음악명:" + selectedMP3);
                        ...
                        public void run() {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    sbMP3.setMax(mediaPlayer.getDuration());
                                }
                            });
                            ...
                            while (mediaPlayer.isPlaying()) {
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        //자기가 진행되는 시간
                                        sbMP3.setProgress(mediaPlayer.getCurrentPosition());
                                        txtTime.setText(selectedMP3 + "진행시간 : " + simpleDateFormat.format(mediaPlayer.getCurrentPosition()));
                                    }
